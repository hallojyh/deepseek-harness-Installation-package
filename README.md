...
- **封装版本**：v0.1.0
- **安装包 / 绿色版 / 发布包**：均见 [Releases](https://github.com/hallojyh/deepseek-harness-/releases) 附件
...
1. 在 [Releases](https://github.com/hallojyh/deepseek-harness-/releases) 下载 `DeepSeek-Harness-Setup.exe` 并双击；
...
安装目录树（`install-files/`）由 `npm install @deepseek-ai/dsh@0.1.0-rc.6` 的依赖树裁剪后得到，`payload.tar.gz` 由该目录打包，均可按脚本重建。
